    ...
    <B24Card class="mb-8">
      <div class="p-6">
        ...
        <div class="space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <div class="flex items-start gap-3">
            <p>На данный момент нет способа через методы REST-API, не зная ID графика, закрепленного за сотрудником, получить информацию о настройках рабочего дня, касательно работы в Субботу и Воскресенье. Поэтому в зависимости от потребностей работу приложения в эти дни можно отрегулировать соответствующей настройкой в приложении - <span class="font-semibold">«Активность в выходные»</span>.</p>
          </div>
        </div>
